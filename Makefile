...
# github.odit.services/ghops-bundle:$VERSION and github.odit.services/ghops-catalog:$VERSION.
IMAGE_TAG_BASE ?= github.odit.services/ghops
...
IMG ?= ghcr.io/odit-services/ghops:v$(VERSION)
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name ghops-builder
	$(CONTAINER_TOOL) buildx use ghops-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm ghops-builder
	rm Dockerfile.cross
